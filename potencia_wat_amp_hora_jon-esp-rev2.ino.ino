...
Ah                    = 0.0000,      // SYSTEM PARAMETER - Almacena lo acomulado en amperes hora (amperes-Hours)
...
void loop() {
  ...
  randamp = random(80, 100);
  randvolt = random(90,100);
powerInput = (randamp*randvolt);
 ...
 int reading = randvolt;
  ...
  Ah = Ah+(randamp/(3600.000*(1000.000/millisRoutineInterval)));  //Accumulate and compute energy harvested (3600s*(1000/interval))
